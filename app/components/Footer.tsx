      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 items-center">
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-2xl font-bold text-[#e5e5e5]">
                <span className="text-amber-500">Open</span>Sox
              </span>
            </div>
          ...
          <div className="flex justify-center md:justify-start space-x-6">
            <a href="https://github.com/shubGupta10/OpenSox" target="_blank" rel="noopener noreferrer" className="text-[#a0a0a0] hover:text-amber-500 transition-colors">
